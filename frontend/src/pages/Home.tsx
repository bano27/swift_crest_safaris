          ...
          <div className="row g-4 mb-4" style={{ alignItems:'flex-start' }}>
            ...
            <div className="col-lg-7">
              ...
              <div className="d-flex gap-4 flex-wrap">
                {[['Best Time', activeDest.bestTime],['Duration', activeDest.duration], activeDest.parkFee.adultUSD > 0 ? ['Park Fees/Day', `Adult $${activeDest.parkFee.adultUSD} · Child $${activeDest.parkFee.childUSD}`] : null].filter(Boolean).map(([l,v]) => (
                  <div key={l as string}>
